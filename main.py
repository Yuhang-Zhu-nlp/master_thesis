...
En_UD = CorpusLoader('English', tree_bank_path, mode='dev', corpus_filter=['UD_English-Atis', 'UD_English-ESLSpok',
...
It_UD = CorpusLoader('Italian', tree_bank_path, mode='train', corpus_filter=['UD_Italian-MarkIT', 'UD_Italian-Old',
